  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      <motion.div
        ...
        className="max-w-7xl mx-auto w-full px-4 md:px-8 pt-4 md:pt-8 min-w-0 overflow-x-hidden flex flex-col flex-1 min-h-0"
      >
        {/* Zona de Ação Rápida */}
        ...
        {/* Conteúdo - Feed e Registros na mesma linha com altura igual (acompanham Agendamentos) */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:grid-rows-[auto_1fr] flex-1 min-h-0">

          {/* Linha 1 - Stats e Appointments */}
          {/* Cards de Estatística - col 1-2 */}
          <div className="grid gap-4 grid-cols-2 lg:grid-cols-3 lg:col-span-2 lg:order-first order-1">
          ...
          {/* Appointments - col 3, linha 1 */}
          <div className="hidden lg:block shrink-0 lg:order-last">
            <AppointmentsCard2
          ...
          {/* Linha 2 - Feed e Registros (mesma altura via grid) */}
          <div id="nutritionist-activity-feed" className="flex flex-col min-h-0 lg:col-span-2 lg:row-start-2 lg:order-first order-3">
            <NutritionistActivityFeed />
          </div>
          <div className="flex flex-col min-h-0 lg:col-span-1 lg:row-start-2 lg:order-last order-4">
