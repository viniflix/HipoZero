...
import { User, Search, Plus, Trash2, Utensils, Save } from 'lucide-react';
...
const CalculatorPage = () => {
  ...
  const [foods] = useState(() => getStoredData('foods', []));
  ...
  const handleSaveToDiary = () => {
    ...
    setStoredData('food_entries', [...allEntries, ...newEntries]);
    setMealItems([]);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">Calculadora de Refeição</h1>
            <p className="text-muted-foreground">Monte uma refeição, calcule os macros e adicione ao seu diário.</p>
          </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input id="search" placeholder="Digite o nome do alimento..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10 bg-background" />
                    </div>
                  ...
                  {selectedFood && (
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
                      <div className="sm:col-span-2">
                        ...
                        <Input id="quantity" type="number" placeholder="100" value={quantity} onChange={(e) => setQuantity(e.target.value)} className="bg-background" />
                      </div>
